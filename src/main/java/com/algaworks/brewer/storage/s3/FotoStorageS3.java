...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "brewerbkt";
	...
	public String getUrl(String foto) {
		if(!StringUtils.isEmpty(foto)) {
			//return "https://brewerbkt.s3.sa-east-1.amazonaws.com/" + foto;
			return "https://s3-sa-east-1.amazonaws.com/brewerbkt/" + foto;
		}
